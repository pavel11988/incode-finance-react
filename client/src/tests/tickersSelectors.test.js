...
describe('getAllTickers', () => {
    test('work with undefined state', () => { 
        expect(tickersSelectors.getAllTickers(undefined)).toStrictEqual([]);
     })
     test('work with {tickers: [{},{},{}]} state', () => { 
        expect(tickersSelectors.getAllTickers({tickers: [
            {
              "ticker": "AAPL",
              "exchange": "NASDAQ",
              "price": 279.29,
